...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  Future<String> updateProfile(
      String uid, String bioController, Uint8List? file) async {
    ...
    try {
      if (bioController.isNotEmpty) {
        docUser.update({'bio': bioController, 'photoUrl': photoUrl});
        return 'success';
      }
    } catch (err) {
      res = err.toString();
        ...
        child: GestureDetector(
          ...
          child: ListView(
            children: [
              ...
              MaterialButton(
                onPressed: () {
                  updateProfile(user.uid, _bioController.text, _image);
                },
                color: blueColor,
