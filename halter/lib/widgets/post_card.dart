      ...
      child: Column(
        children: [
          ...
          SizedBox(
              ...
              child: Image.network('https://images.unsplash.com/photo-1526506118085-60ce8714f8c5?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8Z3ltfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60',
              fit: BoxFit.cover,
              ),
            ),
            //LIKE AND COMMENT
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                      padding: const EdgeInsets.symmetric(vertical: 4),
                      child: Text('23/12/2022', style: const TextStyle(
                        fontSize: 16,
                        color: secondaryColor,
                      ),
                      ),
